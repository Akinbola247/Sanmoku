...
const Header = () => {
  const {
    ...
    account: { create, list, select, account, isDeploying, clear,copyToClipboard},
  } = useDojo();
  ...
  return (
    <div className='w-[100%] h-[80px] absolute border border-b-[#000000]'>
        ...
        <div className='flex space-x-1 bg-[#FF3D00] w-[140px] h-[40px] border border-[#000000] rounded-lg items-center p-2'>
            ...
            <div className='flex w-[140px] border border-[#FF3D00] h-[40px]  rounded-lg items-center p-2' onClick={async () => await copyToClipboard()}>
